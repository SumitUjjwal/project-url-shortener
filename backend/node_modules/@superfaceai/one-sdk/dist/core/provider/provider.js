...
var ProviderConfiguration = /** @class */ (function () {
    function ProviderConfiguration(name, security, parameters) {
        this.name = name;
    ...
    Provider.prototype.configure = function (configuration) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                newConfiguration = new ProviderConfiguration(this.configuration.name, schema_tools_1.mergeSecurity(this.configuration.security, (_a = configuration === null || configuration === void 0 ? void 0 : configuration.security) !== null && _a !== void 0 ? _a : []));
                return [2 /*return*/, new Provider(newConfiguration)];
            });
        });
    };
    return Provider;
