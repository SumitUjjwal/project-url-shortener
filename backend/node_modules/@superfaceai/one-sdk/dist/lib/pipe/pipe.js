...
function pipe(initial) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var accumulator, filters_1, filters_1_1, filter, e_1_1;
        var e_1, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    accumulator = object_1.clone(initial);
                    _b.label = 1;
                case 1:
                ...
                case 2:
                    ...
                    return [4 /*yield*/, filter(accumulator)];
                case 3:
                    accumulator = _b.sent();
                    _b.label = 4;
                case 4:
                ...
                case 7:
                    ...
                    return [7 /*endfinally*/];
                case 8: return [2 /*return*/, accumulator];
            }
        });
    });
}
