...
export declare type MapInterpreterError = IMapASTError | IMappedHTTPError<unknown> | IMappedError<unknown> | IHTTPError | IJessieError;
export declare const isMapInterpreterError: (e: unknown) => e is MapInterpreterError;
