...
export declare type ProfileNodeKind = 'PrimitiveTypeName' | 'ModelTypeName' | 'EnumDefinition' | 'ObjectDefinition' | 'ListDefinition' | 'NonNullDefinition' | 'UnionDefinition' | 'EnumValue' | 'FieldDefinition' | 'NamedFieldDefinition' | 'NamedModelDefinition' | 'UseCaseSlotDefinition' | 'UseCaseDefinition' | 'ProfileHeader' | 'ProfileDocument' | 'UseCaseExample' | 'ComlinkNoneLiteral' | 'ComlinkPrimitiveLiteral' | 'ComlinkObjectLiteral' | 'ComlinkListLiteral' | 'ComlinkAssignment';
...
export declare type ComlinkLiteralNode = ComlinkNoneLiteralNode | ComlinkPrimitiveLiteralNode | ComlinkObjectLiteralNode | ComlinkListLiteralNode;
